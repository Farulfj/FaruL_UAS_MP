...
export default function Blogs() {
  ...
  return (
    <div className="min-h-screen bg-blue-500 p-10">
      <h2 className="text-center text-5xl font-bold w-full mt-24 text-yellow-300">Blog Fahrijal</h2>
      <p className="text-center margin-0 mx-auto w-3/6">
        Halo cari artikel yang ingin kamu cari di sini
      </p>

      {/* Start Search Box */}
      <form onSubmit={handleSearchSubmit} className="flex items-center justify-center my-3 bg-yellow-200 rounded-lg shadow-lg">
        <div className="relative w-full max-w-2xl my-7">
          <input 
            type="search" 
            name="blogsearch"
            className="block w-full p-6 pl-10 text-lg text-gray-900 border border-gray-300 rounded-xl bg-gray-50 focus:ring-blue-500 focus:border-yellow-300" 
            placeholder="Search..."
